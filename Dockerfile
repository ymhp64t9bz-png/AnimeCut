...
# ✂️ AnimeCut Serverless V15.9.7 - FFMPEG COM NVENC (HEADERS ONLY)
# Compila FFmpeg com NVENC usando apenas nv-codec-headers (sem GPU no build)
FROM runpod/pytorch:2.2.1-py3.10-cuda12.1.1-devel-ubuntu22.04

# ==================== FORÇA REBUILD ====================
ARG FORCE_REBUILD=16
ARG BUILD_TIMESTAMP=20251223_0200_V15_9_7_NVENC_HEADERS
...
# ==================== CACHE BUSTER ====================
ARG CACHEBUST=20251223_0200_V15_9_7_NVENC_HEADERS_ONLY
...
ENV BUILD_DATE="2025-12-23T02:00:00Z"
...
# Verifica que os headers estão instalados
RUN ls -la /usr/local/include/ffnvcodec/ && \
    cat /usr/local/lib/pkgconfig/ffnvcodec.pc

# ==================== 3. FFMPEG 5.1.4 COM NVENC (SEM CUDA-NVCC) ====================
# IMPORTANTE: Não usar --enable-cuda-nvcc nem --enable-libnpp
# Esses requerem CUDA SDK completo no build. NVENC funciona só com headers.
RUN cd /tmp && \
...
# ==================== 17. HANDLER ====================
ARG HANDLER_NOCACHE=15.9.7_20251223_0200_NVENC_HEADERS
