...
# -*- coding: utf-8 -*-
"""
AnimeCut Serverless v15.9.5 ENCODING SIMPLIFICADO
BUILD: 2025-12-22 20:00 - FLUXO ÚNICO ROBUSTO
Stack: Whisper V3 Turbo, YOLOv8, DeepFilterNet, FFmpeg NVENC
CORREÇÕES: 
- ENCODING: Um único fluxo simplificado (menos chances de erro)
- PNGs: Criados uma vez e reutilizados
- LOGS: Mais detalhados para diagnóstico
- NVENC: Método principal com fallback CPU
"""
...
if __name__ == "__main__":
    try:
        ...
        print("\n" + "="*70)
        print("╔═══════════════════════════════════════════════════════════════════╗")
        print("║   ANIMECUT SERVERLESS v15.9.5 - BUILD 2025-12-22 20:00           ║")
        print("║   🔧 ENCODING SIMPLIFICADO - FLUXO ÚNICO ROBUSTO                 ║")
        print("╚═══════════════════════════════════════════════════════════════════╝")
        print("Correções v15.9.5:")
        print("  ✓ ENCODING: Fluxo único simplificado")
        print("  ✓ PNGs: Criados uma vez e reutilizados")
        print("  ✓ LOGS: Mais detalhados para diagnóstico")
        print("  ✓ NVENC: GPU como método principal")
        print("  ✓ FALLBACK: CPU com overlay completo")
